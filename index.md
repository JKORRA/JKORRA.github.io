...
<style>
  ...
  .graph-container {
    ...
    width: 100%;
    max-width: 900px;
    height: 750px; /* Altezza ottimizzata */
    margin: 40px auto;
  ...
  .flow-green  { stroke: #30d158; filter: drop-shadow(0 0 4px #30d158); } 
  .flow-purple { stroke: #bf5af2; filter: drop-shadow(0 0 4px #bf5af2); } 
  .flow-orange { stroke: #ff9f0a; filter: drop-shadow(0 0 4px #ff9f0a); } 
  .flow-cyan   { stroke: #64d2ff; filter: drop-shadow(0 0 4px #64d2ff); } 
  .flow-yellow { stroke: #ffcc00; filter: drop-shadow(0 0 4px #ffcc00); } 
  ...
  .node-green:hover { border-color: #30d158; box-shadow: 0 0 15px #30d158; }
  .node-purple:hover { border-color: #bf5af2; box-shadow: 0 0 15px #bf5af2; }
  .node-orange:hover { border-color: #ff9f0a; box-shadow: 0 0 15px #ff9f0a; }
  .node-cyan:hover { border-color: #64d2ff; box-shadow: 0 0 15px #64d2ff; }
  .node-yellow:hover { border-color: #ffcc00; box-shadow: 0 0 15px #ffcc00; }
  ...
  .modal-title { font-size: 2rem; font-weight: 700; margin-bottom: 10px; color: #fff; margin-top: 0; }
...
<div class="main-container">
  ...
  <div class="hero">
    ...
    <p>
      Master's Student in Computer Science at University of Trento.
    </p>
  ...
  <section id="about">
    ...
    <p style="font-size: 1.1rem; line-height: 1.8; color: var(--apple-subtext);">
      ...
      Wanting to pursue new experiences and continue my studies, I decided to move to <strong>Trento</strong>, where I am currently enrolled in a Master’s degree in <strong>Computer Science</strong>, specializing in <strong>Data Science</strong>.</p>
  </section>
  ...
  <section id="skills">
    ...
    <div class="graph-container">
      ...
      <svg class="graph-lines" width="100%" height="100%">
        ...
        <line x1="35%" y1="70%" x2="55%" y2="75%" class="connection-base" />
        
        <line x1="55%" y1="75%" x2="68%" y2="70%" class="connection-base" />
        <line x1="55%" y1="75%" x2="68%" y2="70%" class="connection-flow flow-yellow" />
        ...
        <line x1="94%" y1="75%" x2="83%" y2="85%" class="connection-base" />
        <line x1="94%" y1="75%" x2="83%" y2="85%" class="connection-flow flow-orange" style="animation-direction: alternate;" />
      ...
      <div class="graph-node node-md node-yellow" style="left: 55%; top: 75%;">Git</div>
      <div class="graph-node node-sm node-yellow" style="left: 68%; top: 70%;">LaTeX</div>
      ...
      <div class="graph-node node-sm node-orange" style="left: 83%; top: 85%;">English<br>(B2)</div>
      <div class="graph-node node-sm node-orange" style="left: 94%; top: 75%;">Italian<br>(Native)</div>
  ...
  <section id="projects">
    ...
    <div class="grid">
      ...
      <div class="card project-card" onclick="openModal(this)">
        ...
        <div style="flex-grow: 1;">
            ...
            <p>Quadrifinder will help you find little green lucky charms with the help of Artificial Intelligence. Open the app, frame your favourite lawn and start searching for some four-leaf clovers right away!</p>
        </div>
        ...
        <a href="https://quadrifinder.pappacoda.it" class="hidden-link" style="display:none">View Website</a>
      </div>
      ...
      <div class="card project-card" onclick="openModal(this)">
        ...
        <div style="flex-grow: 1;">
            ...
            <p>Desktop application developed for the management of climate monitoring centres.</p>
        </div>
        ...
        <a href="https://git.sr.ht/~tachi/ClimateMonitoring" class="hidden-link" style="display:none">View Source Code</a>
      </div>
      ...
      <div class="card project-card" onclick="openModal(this)">
        ...
        <div style="flex-grow: 1;">
            ...
            <p>Leveraging Function Calling to optimize local LLM performance and automate workflows directly on personal hardware.</p>
        </div>
        ...
        <a href="#" class="hidden-link" style="display:none"></a>
      </div>
