  ...
  <section id="about" class="about-scroll-section">
    <div class="mesh-wrapper">
      <div class="drag-hint" id="dragHint">
        ...
        <model-viewer src="assets/models/avatar.glb" camera-controls touch-action="pan-y" disable-zoom disable-pan shadow-intensity="1" exposure="1" environment-image="neutral"></model-viewer>
    </div>
